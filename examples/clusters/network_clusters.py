...
train_df = pd.read_csv('C:/Users/wspic/Documents/GitHub/neural-nets/examples/clusters/data/train.csv')
...
test_df = pd.read_csv('C:/Users/wspic/Documents/GitHub/neural-nets/examples/clusters/data/train.csv')
